...
_$UserModelImpl _$$UserModelImplFromJson(Map<String, dynamic> json) =>
    _$UserModelImpl(
      ...
      payment_verification: (json['payment_verification'] as num?)?.toInt(),
      status: (json['status'] as num?)?.toInt(),
      reduced_mobility: (json['reduced_mobility'] as num?)?.toInt(),
      initiation_course: (json['initiation_course'] as num?)?.toInt(),
