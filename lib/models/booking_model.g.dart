...
_$BookingModelImpl _$$BookingModelImplFromJson(
  Map<String, dynamic> json,
) => _$BookingModelImpl(
  id: (json['id'] as num?)?.toInt(),
  bookable_id: (json['bookable_id'] as num?)?.toInt(),
