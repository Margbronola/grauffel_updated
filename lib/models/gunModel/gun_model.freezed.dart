...
/// @nodoc
abstract class _$$GunModelImplCopyWith<$Res>
    implements $GunModelCopyWith<$Res> {
  factory _$$GunModelImplCopyWith(
    _$GunModelImpl value,
    $Res Function(_$GunModelImpl) then,
  ) = __$$GunModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({
    int? id,
...
/// @nodoc
class __$$GunModelImplCopyWithImpl<$Res>
    extends _$GunModelCopyWithImpl<$Res, _$GunModelImpl>
    implements _$$GunModelImplCopyWith<$Res> {
  __$$GunModelImplCopyWithImpl(
    _$GunModelImpl _value,
    $Res Function(_$GunModelImpl) _then,
  ) : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$GunModelImpl with DiagnosticableTreeMixin implements _GunModel {
  const _$GunModelImpl({
    this.id,
    this.model,
    this.brand_id,
    this.caliber_id,
  ...
  factory _$GunModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$GunModelImplFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GunModelImplCopyWith<_$GunModelImpl> get copyWith =>
      __$$GunModelImplCopyWithImpl<_$GunModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GunModelImplToJson(this);
  }
}
...
abstract class _GunModel implements GunModel {
  ...
  factory _GunModel.fromJson(Map<String, dynamic> json) =
      _$GunModelImpl.fromJson;
  ...
  int? get brand_id;
  @override
  int? get caliber_id; // int? mags_capacity,
  @override
  int? get reserve;
  @override
  ...
  double? get price;
  @override
  String? get description; // DateTime? created_at,
  // DateTime? updated_at,
  @override
  ...
  @override
  BrandModel? get brand; // ImageModel? image,
  // List? bookings,
  @override
  int? get quantity;
  @override
  ...
  @override
  String? get image_thumb_url; // List<EquipmentModel>? equipments,
  @override
  List<AmmunitionsModel>? get ammunitions;
