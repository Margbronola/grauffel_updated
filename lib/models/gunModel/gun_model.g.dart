...
_GunModel _$GunModelFromJson(Map<String, dynamic> json) => _GunModel(
  id: (json['id'] as num?)?.toInt(),
  model: json['model'] as String?,
  brand_id: (json['brand_id'] as num?)?.toInt(),
  caliber_id: (json['caliber_id'] as num?)?.toInt(),
  reserve: (json['reserve'] as num?)?.toInt(),
  required_ammunition: (json['required_ammunition'] as num?)?.toInt(),
...
Map<String, dynamic> _$GunModelToJson(_GunModel instance) => <String, dynamic>{
  'id': instance.id,
