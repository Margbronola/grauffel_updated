...
/// @nodoc
abstract class _$$SalleModelImplCopyWith<$Res>
    implements $SalleModelCopyWith<$Res> {
  factory _$$SalleModelImplCopyWith(
    _$SalleModelImpl value,
    $Res Function(_$SalleModelImpl) then,
  ) = __$$SalleModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({
    int? id,
...
/// @nodoc
class __$$SalleModelImplCopyWithImpl<$Res>
    extends _$SalleModelCopyWithImpl<$Res, _$SalleModelImpl>
    implements _$$SalleModelImplCopyWith<$Res> {
  __$$SalleModelImplCopyWithImpl(
    _$SalleModelImpl _value,
    $Res Function(_$SalleModelImpl) _then,
  ) : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$SalleModelImpl implements _SalleModel {
  const _$SalleModelImpl({
    this.id,
    this.name,
    this.description,
    this.location,
  ...
  factory _$SalleModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$SalleModelImplFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$SalleModelImplCopyWith<_$SalleModelImpl> get copyWith =>
      __$$SalleModelImplCopyWithImpl<_$SalleModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$SalleModelImplToJson(this);
  }
}
